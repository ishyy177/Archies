...
public class DessertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = findViewById(R.id.lv_desserts);
        ...
        ArrayAdapter<Dish> arrayAdapter = new ArrayAdapter<>(DessertActivity.this, android.R.layout.simple_list_item_1, desserts);
